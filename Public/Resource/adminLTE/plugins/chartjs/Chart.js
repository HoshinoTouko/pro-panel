...
(function(){
	...
	var each = helpers.each = function(loopable,callback,self){
		...
		template = helpers.template = function(templateString, valuesObject){
			...
			// If templateString is function rather than string-view - call the function for valuesObject
			...
			function tmpl(str, data){
				// Figure out if we're getting a view, or if we need to
				// load the view - and be sure to cache the result.
				var fn = !/\W/.test(str) ?
				cache[str] = cache[str] :

				// Generate a reusable function that will serve as a view
				...
				new Function("obj",
					...
					// Convert the view into pure JavaScript
					str
						.replace(/[\r\t\n]/g, " ")
						.split("<%").join("\t")
						.replace(/((^|%>)[^\t]*)'/g, "$1\r")
